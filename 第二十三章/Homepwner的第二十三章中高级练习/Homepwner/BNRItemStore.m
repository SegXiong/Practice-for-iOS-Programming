...
- (void)creatAssetType:(NSString *)type
{
    NSManagedObject *newType;
    newType = [NSEntityDescription insertNewObjectForEntityForName:@"BNRAssetType" inManagedObjectContext:[BNRItemStore sharedStore].context];
    [newType setValue:type forKey:@"label"];
